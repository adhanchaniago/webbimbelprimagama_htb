...
if(ISSET($_REQUEST['file_materi'])){
 $file = $_REQUEST['file_materi'];
...
$("#pilih_mapel1").change(function() {
	var id_mapel = this.value;
	window.location.assign(base_url+"adm/m_materi/pilih_mapel/"+id_mapel); 
});

$("#id_guru").change(function() {
	var id_guru = this.value;
	window.location.assign(base_url+"adm/m_materi/id_guru/"+id_guru); 
});
