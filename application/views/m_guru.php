            ...
            if (!empty($data)) {
              ...
              foreach ($data as $d) {
                echo '<tr>
					  ...
					  <td class="">
                        <div class="btn-group">
                          <a href="#" onclick="return m_guru_e('.$d->id.');" class="btn btn-info btn-xs"><i class="glyphicon glyphicon-pencil" style="margin-left: 0px; color: #fff"></i> &nbsp;&nbsp;Ubah</a>
          ...
          <form name="f_guru" id="f_guru" onsubmit="return m_guru_s();">
            <input type="hidden" name="id" id="id" value="0">
              <table class="table table-form">
                <tr><td style="width: 20%">Nama:</td><td style="width: 75%"><input type="text" class="form-control" name="nama" id="nama" required></td></tr>
				<tr><td style="width: 20%">NIP:</td><td style="width: 75%"><input type="text" class="form-control" name="nip" id="nip" required></td></tr>
				<tr><td style="width: 20%">Pendidikan:</td><td style="width: 75%"><input type="text" class="form-control" name="pendidikan" id="pendidikan" required></td></tr>
				<tr><td style="width: 25%">Alamat:</td><td style="width: 75%"><input type="text" class="form-control" name="alamat" id="alamat" required></td></tr>
				<tr><td style="width: 15%">No Telepon:</td><td style="width: 75%"><input type="text" class="form-control" name="no_tlp" id="no_tlp" required></td></tr>
