  ...
  <div class="panel panel-info">
    <div class="panel-heading">Data Soal:
      <div class="tombol-kanan">
        <a class="btn btn-success btn-sm" onclick="return m_soal_e(0);"><i class="glyphicon glyphicon-plus" style="margin-left: 0px; color: #fff"></i> &nbsp;&nbsp;Tambah Soal</a>
        &nbsp;
        ...
        ?>
          <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="headingOne">
              <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $no; ?>" aria-expanded="true" aria-controls="collapseOne">
                ...
                <div class="btn-group tombol-kanan">
                <a class="btn btn-info btn-xs" onclick="return m_soal_e('<?php echo $d->id; ?>');"><i class="glyphicon glyphicon-pencil" style="margin-left: 0px; color: #fff"></i> &nbsp;&nbsp;Ubah</a>&nbsp;&nbsp;
                </div>
                <div class="btn-group tombol-kanan">
                <a class="btn btn-primary btn-xs">Pembuat: <?php echo $d->nama_guru; ?></a>&nbsp;&nbsp;
                </div>
            </div>
         ...
         <?php 
          $no++;
            ...
            echo '<div class="alert alert-danger">Belum ada soal untuk mata pelajaran tersebut. Silakan pilih mata pelajaran lain atau tambah soal..</div>';
         }
         ?>
      </div>
    </div>
